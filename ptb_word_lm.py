...
def main(_):
  if not FLAGS.train or not FLAGS.valid or not FLAGS.test:
    raise ValueError("Must set all data paths set to PTB data directory")

  raw_data = reader.ptb_raw_data(FLAGS.train, FLAGS.valid, FLAGS.test)
